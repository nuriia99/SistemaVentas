...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9FEF914B");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F668AA336");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483BDD296FE");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1074841B58E");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E6756CFF8");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13241FC7914");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76CE9799CA");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8B42DD948");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEDF62764D");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A617DCF251");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56142A63B0E4");
    ...
    // Scaffold-DbContext "Server=(local); DataBase=DBVENTA;Integrated Security=true; Encrypt=False" Microsoft.EntityFrameworkCore.SqlServer
}
